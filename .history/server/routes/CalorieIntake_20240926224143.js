...
router.get('/getgoalcalorieintake', authTokenHandler, async (req, res) => {
    ...
    console.log(trackerData.heightInCm[0].height)
    let heightInCm = parseFloat(trackerData.heightInCm.height); 
    console.log(heightInCm) // Accessing heightInCm from tracker object
