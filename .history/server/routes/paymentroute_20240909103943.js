...
router.post('/payment', getUserFromToken,async (req, res) => {
    try {
        ...
        Cashfree.PGCreateOrder({ x_api_version: '2023-08-01' }C,ashfree.XEnvironment, request,) // Ensure CASHFREE_ENV is defined
            .then(response => {
...
router.post('/verify', async (req, res) => {
    try {
        ...
        // Verify payment
        Cashfree.PGOrderFetchPayments(Cashfree.XEnvironment, orderId) // Ensure CASHFREE_ENV is defined
            .then(response => {
