...
router.delete('/deletecalorieintake', authTokenHandler, async (req, res) => {
    ...
    console.log('Current calorie intake before deletion:', user.calorieIntake); // Log current calorie intake

    // Filter out the item to delete
    const updatedCalorieIntake = user.calorieIntake.filter(calorie => 
        !(calorieIntake.item === item && calorieIntake.date === date)
    );
    console.log(updatedCalorieIntake)
    ...
    console.log('Update attempt result:', updateResult); // Log update attempt result
