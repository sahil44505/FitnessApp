...
router.post('/payment', getUserFromToken,async (req, res) => {
    try {
        ...
        Cashfree.PGCreateOrder({ x_api_version: '2023-08-01' }, request,) // Ensure CASHFREE_ENV is defined
            .then(response => {
...
router.post('/verify', async (req, res) => {
    try {
        ...
        // Verify payment
        Cashfree.PGOrderFetchPayments( headers: {
            'x_api_version': '2023-08-01' // Set API version here        }, orderId) // Ensure CASHFREE_ENV is defined
            .then(response => {
