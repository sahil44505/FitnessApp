...
const uri = 'mongodb://localhost:27017/yourDatabaseNa'; // MongoDB URI from environment variables
...
const getUserFromToken = async (req, res, next) => {
    try {
        ...
        const database = client.db('yourdatabase-name'); // Replace with your database name
