...
router.post('/payment', getUserFromToken,async (req, res) => {
    try {
        ...
        let request = {
            ...
            "customer_details": {
                "customer_id": user._id.to, // User ID or another identifier
        ...
        const headers = {
            ...
            'x_client_id': 'TEST1028981802bb3309a937d2c5676381898201', // Add client ID if required
            'x_client_secret': 'cfsk_ma_test_7ecf72afa844b967f878346956ec4b9c_e6e9dbe3'// Add client secret if required
        };

        // Create payment order
        Cashfree.PGCreateOrder(process.env.CASHFREE_ENV, request,{headers}) // Ensure CASHFREE_ENV is defined
            .then(response => {
