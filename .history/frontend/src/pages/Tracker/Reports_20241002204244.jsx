      ...
      .then((data) => {
        ...
        if (data.ok) {
          ...
          if (pathname === '/report/Calorie%20Intake') {
            ...
            setDataForWorkoutGraphs(data.data, 10, setData10Days);
            setDataForWorkoutGraphs(data.data, 30, setData30Days);
            setDataForWorkoutGraphs(data.data, 365, setData365Days);
            setDataForWorkoutGraphs(data.data, 'all', setDataAllTime);
